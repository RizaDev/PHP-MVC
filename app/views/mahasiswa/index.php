<div class="container mt-3">
      ...
      <div class="col-lg-6">
          <form action="<?= BASEURL; ?>/mahasiswa/cari" method="post"> 
            <div class="input-group">
                <input type="text" class="form-control" placeholder="Cari Mahasiswa.." name="cari" id="cari" autocomplete="off" >
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <!-- Tampilkan data mahasiswa dibawah ini -->
            <ul class="list-group tampilDataCari">
